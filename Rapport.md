...
```markdown
# 📘 Rapport de développement — McGonagallPlanner

## 1. Présentation du défi

**Défi : "On n’avait pas cours avec McGonagall"**

Ce projet consiste à créer une application permettant de récupérer et d’afficher l’emploi du temps d’un étudiant à partir de l’API WigorServices. L’objectif est de proposer une solution simple, portable et testée, avec une interface graphique accessible à tous les utilisateurs Windows.
